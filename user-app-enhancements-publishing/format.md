...
7. Optional: A ```RELEASE.md``` file in the root of ZIP, containing what's new and release notes. Otherwise, you have to fill it manually.3. Optional: A ```RELEASE.md``` file in the root of ZIP, containing what's new and release notes. Otherwise, you have to fill it manually.
